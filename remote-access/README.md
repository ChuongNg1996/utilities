...
## Front End vs. Back End (Web Dev)
  "This exact page was created using three **Front End languages**. The words you’re reading are laid out in *HTML*. The spacing and colors are defined by *CSS*. The interactive graphics are the result of *JavaScript*. **Back End languages** working in the background include *Ruby, Python,* and *PHP*... along with **database management tools** like *SQL* and *.Net*."
